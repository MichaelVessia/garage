...
export const status: Effect.Effect<SystemStatus, AdguardError, AdguardApi> = Effect.gen(function* () {
...
export const version: Effect.Effect<VersionResult, AdguardError, AdguardApi> = Effect.gen(function* () {
  const api = yield* AdguardApi
...
export const stats: Effect.Effect<Stats, AdguardError, AdguardApi> = Effect.gen(function* () {
  const api = yield* AdguardApi
  return yield* api.stats()
}).pipe(Effect.withSpan('adguard.stats'), Effect.annotateLogs({ package: '@garage/adguard', operation: 'stats' }))

export const statsInfo: Effect.Effect<StatsInfo, AdguardError, AdguardApi> = Effect.gen(function* () {
  const api = yield* AdguardApi
...
export const queryLog: (options?: LimitOptions) => Effect.Effect<ListResult<QueryLogEntry>, AdguardError, AdguardApi> =
  Effect.fn('adguard.queryLog')(
    function* (options?: LimitOptions): Effect.fn.Return<ListResult<QueryLogEntry>, AdguardError, AdguardApi> {
...
export const queryLogSearch = Effect.fn('adguard.queryLogSearch')(
  function* (options: SearchOptions): Effect.fn.Return<ListResult<QueryLogEntry>, AdguardError, AdguardApi> {
...
export const clients: Effect.Effect<ClientsResult, AdguardError, AdguardApi> = Effect.gen(function* () {
  const api = yield* AdguardApi
...
export const clientsActive = Effect.fn('adguard.clientsActive')(
  function* (options: ClientLookupOptions): Effect.fn.Return<ListResult<ActiveClient>, AdguardError, AdguardApi> {
...
export const filters: Effect.Effect<FiltersResult, AdguardError, AdguardApi> = Effect.gen(function* () {
  const api = yield* AdguardApi
...
export const rules: Effect.Effect<ListResult<string>, AdguardError, AdguardApi> = Effect.gen(function* () {
  const api = yield* AdguardApi
  return yield* api.rules()
}).pipe(Effect.withSpan('adguard.rules'), Effect.annotateLogs({ package: '@garage/adguard', operation: 'rules' }))

export const dnsConfig: Effect.Effect<JsonObject, AdguardError, AdguardApi> = Effect.gen(function* () {
  const api = yield* AdguardApi
...
export const dhcpStatus: Effect.Effect<DhcpStatus, AdguardError, AdguardApi> = Effect.gen(function* () {
  const api = yield* AdguardApi
...
export const protectionToggle = Effect.fn('adguard.protectionToggle')(
  function* (options: ProtectionToggleOptions): Effect.fn.Return<ProtectionState, AdguardError, AdguardApi> {
