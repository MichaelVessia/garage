...
export const status: Effect.Effect<SystemStatus, SabnzbdError, SabnzbdApi> = Effect.gen(function* () {
...
export const version: Effect.Effect<VersionResult, SabnzbdError, SabnzbdApi> = Effect.gen(function* () {
  const api = yield* SabnzbdApi
...
export const queue: (options?: LimitOptions) => Effect.Effect<QueueResult, SabnzbdError, SabnzbdApi> = Effect.fn(
  'sabnzbd.queue'
)(
  function* (options?: LimitOptions): Effect.fn.Return<QueueResult, SabnzbdError, SabnzbdApi> {
...
export const history: (options?: LimitOptions) => Effect.Effect<HistoryResult, SabnzbdError, SabnzbdApi> = Effect.fn(
  'sabnzbd.history'
)(
  function* (options?: LimitOptions): Effect.fn.Return<HistoryResult, SabnzbdError, SabnzbdApi> {
...
export const pause: Effect.Effect<ActionResult, SabnzbdError, SabnzbdApi> = Effect.gen(function* () {
  const api = yield* SabnzbdApi
  return yield* api.pause()
}).pipe(Effect.withSpan('sabnzbd.pause'), Effect.annotateLogs({ package: '@garage/sabnzbd', operation: 'pause' }))

export const resume: Effect.Effect<ActionResult, SabnzbdError, SabnzbdApi> = Effect.gen(function* () {
  const api = yield* SabnzbdApi
...
export const serverStats: Effect.Effect<ServerStats, SabnzbdError, SabnzbdApi> = Effect.gen(function* () {
  const api = yield* SabnzbdApi
